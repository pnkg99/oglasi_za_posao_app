      ...
      <div class="container">
        <div class="row">
            ...
            <div class="box box-solid">
              ...
              <div class="box-body no-padding">
                 <ul class="nav nav-pills nav-stacked">
                  ...
                  <li class="active"><a href="podesavanja.php"><i class="fa fa-gear"></i> Podesavanja</a></li>
          ...
          <div class="col-md-9 bg-white padding-2">
            ...
            <div class="row">
              <div class="col-md-6">
                <form id="changePassword" action="promeni-password.php" method="post">
                  ...
                  <div class="form-group">
                    <button type="submit" class="btn btn-flat btn-success">Promena Lozinke</button>
                  </div>
              ...
              <div class="col-md-6">
                <form action="ugasi-nalog.php" method="post">
                  <label><input type="checkbox" required>Zelim Da Ugasim Moj Nalog</label>
                  <button type="submit" class="btn btn-danger btn-flat btn-lg">Ugasi Moj Nalog</button>
                </form>
              </div>
            </div>
