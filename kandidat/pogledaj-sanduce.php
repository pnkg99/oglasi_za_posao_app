...
if($result->num_rows >  0 ){
  ...
  if($row['fromuser'] == "poslodavac") {
    $sql1 = "SELECT * FROM poslodavac WHERE id_company='$row[id_fromuser]'";
    $result1 = $conn->query($sql1);
    if($result1->num_rows >  0 ){
      $rowCompany = $result1->fetch_assoc();
    }
    $sql2 = "SELECT * FROM kandidati WHERE id_user='$row[id_touser]'";
    $result2 = $conn->query($sql2);
    if($result2->num_rows >  0 ){
      $rowUser = $result2->fetch_assoc();
    }
  } else {
    $sql1 = "SELECT * FROM poslodavac WHERE id_company='$row[id_touser]'";
    $result1 = $conn->query($sql1);
    if($result1->num_rows >  0 ){
      $rowCompany = $result1->fetch_assoc();
    }
    $sql2 = "SELECT * FROM kandidati WHERE id_user='$row[id_fromuser]'";
    $result2 = $conn->query($sql2);
    if($result2->num_rows >  0 ){
      $rowUser = $result2->fetch_assoc();
    }
      ...
      <div class="container">
        <div class="row">
            ...
            <div class="box box-solid">
              ...
              <div class="box-body no-padding">
                <ul class="nav nav-pills nav-stacked">
                  <li><a href="uredi-profil.php"><i class="fa fa-user"></i> Edit Profile</a></li>
                  <li><a href="index.php"><i class="fa fa-address-card-o"></i> Moje Aplikacije</a></li>
                  <li class="active"><a href="sanduce.php"><i class="fa fa-envelope"></i> Postansko Sanduce</a></li>
          ...
          <section class="content">
            <div class="row">
              <div class="col-md-12">
                <a href="sanduce.php" class="btn btn-default"><i class="fa fa-arrow-circle-left"></i> Back</a>
                <div class="box box-primary">
                  <!-- /.box-header -->
                  <div class="box-body no-padding">
                    <div class="mailbox-read-info">
                      <h3><?php echo $row['subject']; ?></h3>
                      <h5>From: <?php if($row['fromuser'] == "poslodavac") { echo $rowCompany['imefirme']; } else { echo $rowUser['firstname']; } ?>
                        <span class="mailbox-read-time pull-right"><?php echo date("d-M-Y h:i a", strtotime($row['datum'])); ?></span></h5>
                    </div>
                ...
                if($resultReply->num_rows > 0) {
                  ...
                  <div class="box box-primary">
                    <div class="box-body no-padding">
                      <div class="mailbox-read-info">
                        <h3>Reply Message</h3>
                        <h5>From: <?php if($rowReply['usertype'] == "poslodavac") { echo $rowCompany['imefirme']; } else { echo $rowUser['firstname']; } ?>
                          <span class="mailbox-read-time pull-right"><?php echo date("d-M-Y h:i a", strtotime($rowReply['datum'])); ?></span></h5>
                      </div>
                      <div class="mailbox-read-message">
                ...
                <div class="box box-primary">
                  ...
                  <div class="box-body no-padding">
                    ...
                    <div class="mailbox-read-message">
                      <form action="odgovori-sanduce.php" method="post">
