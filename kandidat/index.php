      ...
      <div class="container">
        <div class="row">
            ...
            <div class="box box-solid">
              ...
              <div class="box-body no-padding">
               <ul class="nav nav-pills nav-stacked">
                  ...
                  <li class="active"><a href="index.php"><i class="fa fa-address-card-o"></i> Moje Aplikacije</a></li>
          ...
          <div class="col-md-9 bg-white padding-2">
            <h2><i>Najnovije Aplikacije</i></h2>
            <p>Below you will find job roles you have applied for</p>

            <?php
             $sql = "SELECT * FROM oglasi_za_posao INNER JOIN prijava_za_oglas ON oglasi_za_posao.id_jobpost=prijava_za_oglas.id_jobpost WHERE prijava_za_oglas.id_user='$_SESSION[id_user]'";
            ...
            <div class="attachment-block clearfix padding-2">
                <h4 class="attachment-heading"><a href="pogledaj-poslove.php?id=<?php echo $row['id_jobpost']; ?>"><?php echo $row['jobtitle']; ?></a></h4>
