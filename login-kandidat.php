...
<div class="login-box">
  ...
  <div class="login-box-body">
    <p class="login-box-msg">Prijavi se kandidata</p>

    <form method="post" action="proveri-login-kandidata.php">
    ...
    if(isset($_SESSION['registerCompleted'])) {
      ?>
      <div>
        <p id="successMessage" class="text-center">Uspesno ste kreirali nalog!</p>
      </div>
    <?php
    ...
    if(isset($_SESSION['loginError'])) {
      ?>
      <div>
        <p class="text-center">Pogresni kredencijali, pokusajte ponovo!</p>
      </div>
    <?php
    ...
    if(isset($_SESSION['userActivated'])) {
      ?>
      <div>
        <p class="text-center">Vas Akaunt je aktivan, mozete se prijaviti!
        </p>
      </div>
    <?php
