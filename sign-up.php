    ...
    <section class="content-header">
      <div class="container">
        <div class="row latest-job margin-top-50 margin-bottom-20">
          <h1 class="text-center margin-bottom-20">Registruj se</h1>
          <div class="col-md-6 latest-job ">
            <div class="small-box bg-green padding-5">
              <div class="inner">
                <h3 class="text-center">Kandidat</h3>
              </div>
              <a href="registruj-kandidata.php" class="small-box-footer">
                Registruj se <i class="fa fa-arrow-circle-right"></i>
              </a>
            </div>
          </div>
          <div class="col-md-6 latest-job ">
            <div class="small-box bg-red padding-5">
              <div class="inner">
                <h3 class="text-center">Poslodavac</h3>
              </div>
              <a href="registruj-poslodavca.php" class="small-box-footer">
                Registruj se <i class="fa fa-arrow-circle-right"></i>
              </a>
            </div>
          </div>
