...
$sql = "SELECT * FROM prijava_za_oglas WHERE id_company='$_SESSION[id_company]' AND id_user='$_GET[id]'";
        ...
        <div class="row">
            ...
            <div class="box box-solid">
              ...
              <div class="box-body no-padding">
                <ul class="nav nav-pills nav-stacked">
                  ...
                  <li class="active"><a href="moji-poslovi.php"><i class="fa fa-file-o"></i> Moji Oglasi za Posao</a></li>
          ...
          <div class="col-md-9 bg-white padding-2">
            <div class="row margin-top-20">
              <div class="col-md-12">
              <?php
               $sql = "SELECT * FROM kandidati WHERE id_user='$_GET[id]'";
                $result = $conn->query($sql);
                ...
                <div class="pull-right">
                  <a href="aplikacije-za-posao.php" class="btn btn-default btn-lg btn-flat margin-top-20"><i class="fa fa-arrow-circle-left"></i> Back</a>
                </div>
                ...
                <div>
                  <?php
                    ...
                    echo '<br>';
                    if($row['rezime'] != "") {
                      echo '<a href="../uploads/rezime/'.$row['rezime'].'" class="btn btn-info" download="Resume">Download Resume</a>';
                    }
                    echo '<br>';
                    echo '<br>';
                    echo '<br>';
                  ...
                  <div class="row">
                    ...
                    <div class="col-md-3 pull-right">
                      <a href="odbiti-prijavu.php?id=<?php echo $row['id_user']; ?>&id_jobpost=<?php echo $_GET['id_jobpost']; ?>" class="btn btn-danger">Reject Application</a>
                    </div>
                  </div>
                </div>
