      ...
      <div class="container">
        <div class="row">
            ...
            <div class="box box-solid">
              ...
              <div class="box-body no-padding">
                <ul class="nav nav-pills nav-stacked">
                  ...
                  <li class="active"><a href="aplikacije-za-posao.php"><i class="fa fa-file-o"></i> Prijave za Posao</a></li>
          ...
          <div class="col-md-9 bg-white padding-2">
            ...
            <?php
             $sql = "SELECT * FROM oglasi_za_posao INNER JOIN prijava_za_oglas ON oglasi_za_posao.id_jobpost=prijava_za_oglas.id_jobpost  INNER JOIN kandidati ON kandidati.id_user=prijava_za_oglas.id_user WHERE prijava_za_oglas.id_company='$_SESSION[id_company]'";
