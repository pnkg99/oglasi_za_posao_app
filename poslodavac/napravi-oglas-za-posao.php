      ...
      <div class="container">
        <div class="row">
            ...
            <div class="box box-solid">
              ...
              <div class="box-body no-padding">
                <ul class="nav nav-pills nav-stacked">
                  ...
                  <li class="active"><a href="napravi-oglas-za-posao.php"><i class="fa fa-file-o"></i> Napravite Oglas za Posao</a></li>
          ...
          <div class="col-md-9 bg-white padding-2">
            <h2><i>Napravite Oglas za Posao</i></h2>
            <div class="row">
              <form method="post" action="dodaj-oglas.php">
                <div class="col-md-12 latest-job ">
                  ...
                  <div class="form-group">
                <input type="number" class="form-control  input-lg" id="experience" autocomplete="off" name="experience" placeholder="Radno Iskustvo (in Godina) Required" required="">
                  </div>
                  <div class="form-group">
                    <input type="text" class="form-control  input-lg" id="kvalifikacija" name="kvalifikacija" placeholder="Qualification Required" required="">
                  </div>
                  <div class="form-group">
