        ...
        <div class="row">
            ...
            <div class="box box-solid">
              ...
              <div class="box-body no-padding">
                <ul class="nav nav-pills nav-stacked">
                  <li class="active"><a href="index.php"><i class="fa fa-dashboard"></i> Kontrolna Tabla</a></li>
          ...
          <div class="col-md-9 bg-white padding-2">
            ...
            <div class="alert alert-info alert-dismissible">
                ...
                <i class="icon fa fa-info"></i>Na ovoj kontrolnoj tabli možete da menjate podešavanja naloga, postavljate i upravljate svojim poslovima
            </div>
            ...
            <div class="row">
              <div class="col-md-6">
                <div class="info-box bg-c-yellow">
                  ...
                  <div class="info-box-content">
                    ...
                    <?php
                    $sql = "SELECT * FROM oglasi_za_posao WHERE id_company='$_SESSION[id_company]'";
              ...
              <div class="col-md-6">
                <div class="info-box bg-c-yellow">
                  ...
                  <div class="info-box-content">
                    <span class="info-box-text">Aplikacija za Posao</span>
                    <?php
                    $sql = "SELECT * FROM prijava_za_oglas WHERE id_company='$_SESSION[id_company]'";
                    $result = $conn->query($sql);
