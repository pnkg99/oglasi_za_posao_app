              ...
              <div class="box-body">
                <div class="form-group">
                  <select name="to" class="form-control">
                    <?php 
                    $sql = "SELECT * FROM prijava_za_oglas INNER JOIN kandidati ON prijava_za_oglas.id_user=kandidati.id_user WHERE prijava_za_oglas.id_company='$_SESSION[id_company]' AND prijava_za_oglas.status='2'";
